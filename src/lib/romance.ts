...
export const FALLBACK_PROPERTIES: DateProperty[] = [
  { id: 'p1', name: '商店街の角の2階建て', features: ['商店街に近い', '1階が広い', '日当たりがいい'] },
  { id: 'p2', name: '駅裏の新築アパート', features: ['新しい', '狭い', '庭がない', '騒がしい'] },
  { id: 'p3', name: '丘の上の庭付き一戸建て', features: ['庭付き', '静か', '日当たりがいい', '広い'] },
  ...
  { id: 'p7', name: '公園前のメゾネット', features: ['日当たりがいい', '広い', '庭がない', '家賃が高い'] },
